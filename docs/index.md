...
- **On-demand DLQ reprocessing** — `IDlqReprocessTrigger<TMessage>` runs a retry sweep immediately
- **DLQ inspection** — `IDlqInspector<TMessage>` reads the dead letter topic without consuming it
