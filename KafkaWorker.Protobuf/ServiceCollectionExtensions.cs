...
public static class ServiceCollectionExtensions
{
    ...
    public static IServiceCollection AddKafkaWorkerProtobuf<TMessage, THandler>(
        ...
        => AddKafkaWorkerProtobuf<string, TMessage, THandler>(services, configuration, configSection, configureConsumer, configureProducer);
        ...
        where THandler : class, IMessageHandler<TMessage>
    {
        ...
        {
            b.SetValueSerializer(new ProtobufSerializer<TMessage>(sp.GetRequiredService<ISchemaRegistryClient>()).AsSyncOverAsync());
        }, configureProducer);
