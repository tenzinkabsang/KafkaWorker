...
public static class ServiceCollectionExtensions
{
    ...
    /// </remarks>
    public static IServiceCollection AddKafkaWorkerAvroBatch<TMessage, THandler>(
        this IServiceCollection services, IConfiguration configuration,
        string configSection = KafkaWorkerConfig.Section,
        Action<ConsumerConfig>? configureConsumer = null,
        Action<ProducerConfig>? configureProducer = null,
        ...
        => AddKafkaWorkerAvroBatch<string, TMessage, THandler>(services, configuration, configSection, configureConsumer, configureProducer, configureSerializer);

    /// <inheritdoc cref="AddKafkaWorkerAvroBatch{TMessage, THandler}"/>
    /// <typeparam name="TKey">The message key type.</typeparam>
    /// <typeparam name="TMessage">The Avro-generated message type to consume.</typeparam>
    /// <typeparam name="THandler">The batch handler implementation type.</typeparam>
    public static IServiceCollection AddKafkaWorkerAvroBatch<TKey, TMessage, THandler>(
        this IServiceCollection services, IConfiguration configuration,
        string configSection = KafkaWorkerConfig.Section,
        Action<ConsumerConfig>? configureConsumer = null,
        Action<ProducerConfig>? configureProducer = null,
